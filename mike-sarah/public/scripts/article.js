...
function Article(rawDataObj) {
  /* DONE: This is a new construct to save all the properties of rawDataObj into our newly instantiated object. Object.keys is a function that returns an array of all the properties of an object as strings. forEach is an array method that iterates over and calls a function on each element of an array.
...
// DONE: The parameter was refactored to expect the data from the database, rather than a local file.
...
// DONE: Take a few minutes and review what each of these new methods do in relation to our server and DB
